<script lang="ts">
	...
	const keyStats = [
		...
		{ label: 'Productivity', value: 'up to 3,000 m²/h' },
		{ label: 'Tanks', value: '60 L / 65 L' },
		{ label: 'Runtime (ECO)', value: 'up to 5 hours' }
	];
	...
	const highlights = [
		{
			...
			description: 'Cleans up to 3,000 m² per hour, ideal for large malls, supermarkets and public buildings.',
			image: images.highlights.coverage
		},
		{
			title: 'Runtime',
			subtitle: 'Up to 5 hours runtime',
			description: 'ECO mode delivers up to 5 hours of work time on a single charge, supporting long shifts.',
			image: images.highlights.runtime
		},
		{
			title: 'Self-propelled traction',
			subtitle: 'Traction-assisted drive',
			description: 'Integrated traction motor makes it easy to control and push, even when tanks are full.',
			image: images.highlights.traction
		},
		{
			title: 'Simple controls',
			subtitle: 'Intelligent operation',
			description: 'One-key start and an intelligent panel simplify operation for new and experienced staff.',
			image: images.highlights.controls
		},
		{
			title: 'Quiet cleaning',
			subtitle: 'Battery powered',
			description: 'Battery drive removes trailing cables and supports low-noise cleaning during trading hours.',
			image: images.highlights.quiet
		},
		{
			title: 'Built for busy facilities',
			subtitle: 'High-capacity design',
			description: 'High-capacity tanks, traction drive and strong vacuum performance suit malls, schools, hospitals, warehouses and transport hubs.',
	...
	const usecases = [
		{
			...
			description: 'Main aisles, fresh food areas, checkout zones and back-of-house loading corridors.',
			image: images.usecases.supermarket
		},
		{
			title: 'Shopping centres & public malls',
			description: 'Long corridors, food courts, entrances and shared circulation spaces.',
			image: images.usecases.mall
		},
		{
			title: 'Schools, universities & training centres',
			description: 'Wide corridors, halls, gym floors and campus common areas.',
			image: images.usecases.schools
		},
		{
			title: 'Healthcare & aged care facilities',
			description: 'High-traffic corridors, service corridors and large shared spaces where clean, dry floors are critical.',
			image: images.usecases.healthcare
		},
		{
			title: 'Warehouses, light industrial & workshops',
			description: 'Production zones, packing areas, around racking and loading docks.',
			image: images.usecases.warehouse
		},
		{
			title: 'Transport, venues & public buildings',
			description: 'Airport concourses, exhibition centres, stadium concourses and civic buildings.',
	...
	const specifications = {
		...
		power: [
			...
			{ label: 'Battery type & capacity', value: 'Maintenance-free batteries, 85 Ah' },
			{ label: 'Max runtime (ECO)', value: 'up to 5 hours' }
		],
		motors: [
			{ label: 'Brush motor power', value: '500 W' },
	...
	const accessories = [
		{
			title: 'Brushes & pads',
			description: 'Different brushes and pad types for smooth tiles, textured concrete and coated floors.',
			image: images.accessories.brushes
		},
		{
			title: 'Squeegee blades',
			description: 'Standard and oil-resistant blades for retail, industrial and workshop environments.',
			image: images.accessories.squeegee
		},
		{
			title: 'Cleaning chemicals',
			description: 'Auto-scrubber compatible neutral detergents and degreasers for high-traffic hard floors.',
			image: images.accessories.chemicals
		},
		{
			title: 'Handling & storage',
			description: 'Ramps, transport kits and covers to support moving and storing the machine between sites.',
...
<svelte:head>
	<title>MZL F60 Self-Propelled Walk-Behind Floor Scrubber | MZL Machines</title>
	<meta
		name="description"
		content="MZL F60 - High-capacity, traction-assisted scrubbing for busy commercial floors. 560 mm cleaning width, up to 3,000 m²/h productivity and 60/65 L tanks with up to 5 hours runtime."
	/>
</svelte:head>
...
<section class="hero">
	...
	<div class="hero-container">
		<div class="hero-content">
			...
			<p class="hero-tagline">High-capacity, traction-assisted scrubbing for busy commercial floors.</p>
...
<section class="section highlights-section animate-section">
	<div class="section-container">
		<div class="section-header animate-item">
			...
			<h2 class="section-title">Key features of the MZL F60 traction floor scrubber</h2>
		</div>
...
<section class="section usecases-section animate-section">
	...
	<div class="section-container">
		<div class="section-header animate-item">
			...
			<h2 class="section-title">Where the MZL F60 traction scrubber works best</h2>
			<p class="section-subtitle">
				The MZL F60 is a high-capacity, self-propelled walk-behind scrubber-dryer for large, busy sites. 
				It is designed for frequent cleaning of hard floors where productivity and operator comfort are important.
			</p>
		</div>
	...
	<div class="section-container">
		...
		<div class="performance-block">
			<div class="performance-content animate-item">
				...
				<ul class="performance-list">
					<li>Disc brush configuration for strong mechanical agitation on hard and resilient floors</li>
					<li>560 mm scrubbing width for productive cleaning of large open areas</li>
					<li>500 W brush motor provides robust scrubbing power for demanding sites</li>
				</ul>
			</div>
		...
		<div class="performance-block reverse">
			<div class="performance-content animate-item">
				...
				<ul class="performance-list">
					<li>60 L solution tank supports long runs between refills</li>
					<li>65 L recovery tank captures more dirty water for extended cleaning cycles</li>
					<li>ECO mode helps reduce solution consumption and extend runtime on maintenance cleans</li>
					<li>Solenoid valve stops solution flow when the brush stops to prevent over-wetting</li>
				</ul>
			</div>
			<div class="performance-image">
		...
		<div class="performance-block">
			<div class="performance-content animate-item">
				...
				<ul class="performance-list">
					<li>400 W suction motor provides strong water pickup</li>
					<li>800 mm squeegee collects slurry efficiently behind the scrub path</li>
					<li>Scrubbing and vacuuming work together so floors are cleaned and dried in one pass</li>
				</ul>
			</div>
			<div class="performance-image">
		...
		<div class="battery-grid">
			<div class="battery-content animate-item">
				<div class="battery-specs">
					...
					<div class="battery-spec">
						<span class="battery-spec-value">5 hrs</span>
						<span class="battery-spec-label">Max runtime (ECO)</span>
					</div>
				</div>
				<p class="battery-description">
					24 V system using 2 × 12 V, 85 Ah maintenance-free batteries. 
					Max working duration up to 5 hours in ECO mode. Traction motor provides self-propelled forward motion with a dedicated charger for simple end-of-shift charging.
				</p>
			</div>
	...
	<div class="section-container">
		...
		<div class="easeofuse-grid">
			<div class="easeofuse-card animate-item">
				...
				<h3>One-key control</h3>
				<p>One-button start simplifies operation at the beginning of each shift</p>
			</div>
			<div class="easeofuse-card animate-item">
				<div class="easeofuse-icon">
					<svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
				...
				<h3>Intelligent panel</h3>
				<p>Clear controls and indicators help operators monitor machine status</p>
			</div>
			<div class="easeofuse-card animate-item">
				<div class="easeofuse-icon">
					<svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
				...
				<h3>ECO mode selection</h3>
				<p>Quickly switch to ECO mode for extended runtime on light soils</p>
			</div>
			<div class="easeofuse-card animate-item">
				<div class="easeofuse-icon">
					<svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
				...
				<p>Traction motor makes manoeuvring easier, even on slopes or with full tanks</p>
			</div>
			<div class="easeofuse-card animate-item">
				<div class="easeofuse-icon">
					<svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
				...
				<h3>Automatic brush lift</h3>
				<p>Automatic lift/drop (where fitted) reduces manual handling of the scrub deck</p>
			</div>
		</div>
	...
	<div class="section-container">
		...
		<div class="safety-grid">
			<div class="safety-card animate-item">
				...
				<h3>Drier floors</h3>
				<p>Strong vacuum and an 800 mm squeegee help remove solution quickly and support slip-risk reduction</p>
			</div>
			<div class="safety-card animate-item">
				<div class="safety-icon cable"></div>
				<h3>Automatic water stop</h3>
				<p>Solenoid valve stops water when the brush stops, reducing the chance of puddling</p>
			</div>
			<div class="safety-card animate-item">
				<div class="safety-icon tanks"></div>
				<h3>Failure reminder</h3>
				<p>Alerts and auto-stop functions help protect the machine and operators if an issue occurs</p>
			</div>
			<div class="safety-card animate-item">
				<div class="safety-icon certified"></div>
				<h3>Separated tanks</h3>
				<p>Dedicated solution and recovery tanks improve hygiene and make cleaning the machine easier</p>
			</div>
			<div class="safety-card animate-item">
				<div class="safety-icon certified"></div>
				<h3>Certified construction</h3>
				<p>Manufactured with CE and RoHS certifications and additional compliance reports available</p>
			</div>
		</div>
	</div>
</section>
		...
		<div class="dimensions-grid">
			<div class="dimensions-content animate-item">
				...
				<p class="dimensions-note">
					Self-propelled, walk-behind format allows controlled movement through wide aisles, foyers and corridors. 
					Compact height helps visibility around the machine in busy environments such as malls and supermarkets.
				</p>
			</div>
...
<section class="section included-section animate-section">
	...
	<div class="section-container">
		<div class="section-header animate-item">
			...
			<h2 class="section-title">What's included with the MZL F60 traction scrubber</h2>
		</div>

		<div class="included-grid">
			<div class="included-list animate-item">
				<ul>
					<li>MZL F60 self-propelled walk-behind floor scrubber with traction system</li>
					<li>Disc brush or pad driver (model configuration)</li>
					<li>Squeegee assembly with blades</li>
					<li>Maintenance-free batteries installed</li>
					<li>Dedicated battery charger</li>
					<li>Operator manual and basic tool kit</li>
				</ul>
			</div>
...
<section class="section specs-section animate-section">
	<div class="section-container">
		<div class="section-header animate-item">
			...
			<h2 class="section-title">MZL F60 traction walk-behind floor scrubber</h2>
		</div>
